...
public class ResourceFactory {
    ...
    public static CharacterComponent createLightBulbCharacterComponent(Character character, String lightBulbCharacterImageUrl) {
        return new CharacterComponent(character, lightBulbCharacterImageUrl);
    }
