package components.tabs.machine.configuration.setter.selectors.plugs;

import components.tabs.machine.configuration.setter.selectors.plugs.selection.row.PlugsSelectionRow;
...
public class PlugsSelector {
    ...
    public void setUpPlugsSelector(List<Character> allKeys) {
